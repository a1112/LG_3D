...
group.add_argument('--train-split', metavar='NAME', default='cropped_images',
                   help='dataset train split (default: train)')
group.add_argument('--val-split', metavar='NAME', default='cropped_images',
...
group.add_argument('--model', default='mambaout_small_rw.sw_e450_in1k', type=str, metavar='MODEL',
